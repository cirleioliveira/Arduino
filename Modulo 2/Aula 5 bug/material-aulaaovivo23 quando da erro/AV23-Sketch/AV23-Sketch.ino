...
void debug(int pontoParada, String nomeVariavel, String valorVariavel, int tempoParada = -1);
...
void loop() {
  ...
  #if habilitaDebugSerial == true
      //debug(1, "variavel1", String(variavel1), 0);
  #endif
  ...
  if ((variavel1 % 2) == 0) {
     ...
     variavel2 = false;
      ...
      debug(2, "variavel2", String(variavel2), -1);
  #endif
}
