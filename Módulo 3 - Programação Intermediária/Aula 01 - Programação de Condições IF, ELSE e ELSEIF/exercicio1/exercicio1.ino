...
void loop() {
  ...
  byte estadoLEDs;
  if (!estadoBotao1 || !estadoBotao2 ) estadoLEDs = 1;
  if (!estadoBotao1 && !estadoBotao2 ) estadoLEDs = 3;
  if (!estadoBotao3) estadoLEDs = 2;
  if ( (estadoBotao1 && estadoBotao2) && estadoBotao3 ) estadoLEDs = 3;
